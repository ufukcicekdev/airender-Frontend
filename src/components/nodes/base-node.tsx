...
export function BaseNode({
  ...
  return (
    ...
    >
      ...
      <motion.div className={cn("rounded-t-xl bg-gradient-to-br px-3 py-2", color)}>
      ...
      {isProcessing && (
        <motion.div className="h-1 w-full overflow-hidden bg-secondary">
          <motion.div
      ...
      {children && <motion.div className="space-y-2 p-3">{children}</motion.div>}
